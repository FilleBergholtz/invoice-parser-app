...
def test_document_with_pages():
    """Test Document with pages - manually adding pages."""
...
def test_document_page_count_mismatch_init():
    """Test that Document raises error if initialized with mismatch."""
